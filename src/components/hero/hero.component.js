  ...
  return (
    <section className="o-grid c-hero__section" id="hero">
      ...
      <div className="o-grid__item--center c-hero__text">
        ...
        <h2 className="c-hero__subtitle" style={{ animationDelay: "1300ms" }}>Developer, Designer, Teacher</h2>
        <p className="c-body-text c-hero__description" style={{ animationDelay: "1450ms" }}>{
      ...
      <div className="o-grid__item--full">
        <Waves className="c-hero__waves" style={{ animationDelay: "1600ms" }} />
      </div>
    </section>
  );
};
